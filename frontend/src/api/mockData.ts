...
export const initialMockProducts: MockProduct[] = [
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1608270199049-577cf3a98528?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 42.0,
    selling_price: 55.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 25.0,
    selling_price: 34.0,
    stock_quantity: 80.0,
    reorder_level: 20.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1556881286-fc6915169721?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 22.0,
    selling_price: 30.0,
    stock_quantity: 65.0,
    reorder_level: 15.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1548839140-29a749e1bc4e?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 14.0,
    selling_price: 20.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1612927601601-6638404737ce?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 13.5,
    selling_price: 18.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 48.0,
    selling_price: 62.0,
    stock_quantity: 50.0,
    reorder_level: 12.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 42.0,
    selling_price: 54.0,
    stock_quantity: 45.0,
    reorder_level: 12.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 82.0,
    selling_price: 105.0,
    stock_quantity: 40.0,
    reorder_level: 10.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1598449356475-b9f71db7d847?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 40.0,
    selling_price: 52.0,
    stock_quantity: 60.0,
    reorder_level: 15.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1621447504864-d8686e12698c?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 32.0,
    selling_price: 43.0,
    stock_quantity: 55.0,
    reorder_level: 15.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1607006314633-875f6ca68160?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 48.0,
    selling_price: 60.0,
    stock_quantity: 85.0,
    reorder_level: 15.0,
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1585421514738-01798e348b17?auto=format&fit=crop&w=400&h=400&q=80',
    cost_price: 15.0,
    selling_price: 20.0,
